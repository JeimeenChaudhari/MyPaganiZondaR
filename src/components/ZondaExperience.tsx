      ...
      >
        <div className="text-center max-w-4xl">
          <motion.div
            ...
            className="mb-4"
          >
            <span className="font-rajdhani text-sm tracking-[0.5em] uppercase text-pagani-gold drop-shadow-[0_2px_8px_rgba(0,0,0,0.9),0_0_20px_rgba(212,175,55,0.3)]">
              Track-Only Hypercar
            </span>
          </motion.div>
          ...
          <motion.h1
            ...
            className="font-orbitron text-5xl md:text-7xl lg:text-8xl font-bold tracking-[0.2em] mb-2"
          >
            <span className="text-pagani-gold text-gold-border drop-shadow-[0_4px_12px_rgba(0,0,0,0.95),0_0_30px_rgba(212,175,55,0.4)]">
              {carData.hero.title}
            </span>
          </motion.h1>
        ...
        >
          <span className="font-rajdhani text-xs tracking-[0.3em] uppercase text-muted-foreground">
            Scroll to Explore
          </span>
